...
from openapi_server.models.auth_response_user import AuthResponseUser
try:
...
class AuthResponse(BaseModel):
    ...
    AuthResponse
    """ # noqa: E501
    user: Optional[AuthResponseUser] = None
    ...
    __properties: ClassVar[List[str]] = ["user", "accessToken", "refreshToken", "validUntil"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user": AuthResponseUser.from_dict(obj.get("user")) if obj.get("user") is not None else None,
